...
document.getElementById("span_sketch_drawn").innerHTML = "Sketch To Be Drawn: "+Element_of_array;
...
function check_sketch(){
    ...
    if(timer_counter>500){
        document.getElementById("sketch_guess").innerHTML = "Your Sketch: ";
        document.getElementById("sketch_guess").innerHTML = "Confidence: ";
        timer_counter = 0;
...
function updateCanvas(){
    ...
    element_of_array = Quick_draw_data_set[Random_number];
    sketch = element_of_array;
    document.getElementById("span_sketch_drawn").innerHTML = "Sketch To Be Drawn: "+sketch;
}
...
function gotResults(error,results){
    ...
    document.getElementById("sketch_guess").innerHTML = "Your Sketch: "+results[0].label;
